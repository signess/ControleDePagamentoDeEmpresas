...
namespace ControleDePagamentoDeEmpresas.Services
{
    public static class SqliteDataAccess
    {
        ...
        private static void SaveEmpresaMotomix(EmpresaModel empresa)
        {
        ...
        private static void SaveEmpresaW4(EmpresaModel empresa)
        {
            if (empresa.Prioridade == Prioridade.Mensal)
            {
                using (IDbConnection cnn = new SQLiteConnection(LoadConnectionString()))
        ...
        private static void SaveEmpresaMotomix(EmpresaModel empresa, int index)
        {
            using (IDbConnection cnn = new SQLiteConnection(LoadConnectionString()))
            {
                if (index == 0)
        ...
        private static void SaveEmpresaW4(EmpresaModel empresa, int index)
        {
            using (IDbConnection cnn = new SQLiteConnection(LoadConnectionString()))
            {
                if (index == 0)
        ...
        public static void SaveEmpresa(EmpresaModel empresa)
        {
            ...
            {
                SaveEmpresaMotomix(empresa);
            }
            else if (empresa.Loja == Loja.W4)
            {
                SaveEmpresaW4(empresa);
            }
            else if (empresa.Loja == Loja.Todas)
            {
                SaveEmpresaMotomix(empresa);
                SaveEmpresaW4(empresa);
            }
        ...
        private static void DeleteEmpresaMotomix(EmpresaModel empresa)
        {
            using (IDbConnection cnn = new SQLiteConnection(LoadConnectionString()))
            {
        ...
        private static void DeleteEmpresaW4(EmpresaModel empresa)
        {
            using (IDbConnection cnn = new SQLiteConnection(LoadConnectionString()))
            {
        ...
        public static void DeleteEmpresa(EmpresaModel empresa)
        {
            ...
            if (empresa.Loja == Loja.Motomix)
            {
                DeleteEmpresaMotomix(empresa);
            }
            else if (empresa.Loja == Loja.W4)
            {
                DeleteEmpresaW4(empresa);
            }
            else if (empresa.Loja == Loja.Todas)
            {
                DeleteEmpresaMotomix(empresa);
        ...
        public static void DeleteEmpresaMotomix(EmpresaModel empresa, int index)
        {
            if (empresa.Loja == Loja.Motomix || empresa.Loja == Loja.Todas)
            {
                using (IDbConnection cnn = new SQLiteConnection(LoadConnectionString()))
        ...
        public static void DeleteEmpresaW4(EmpresaModel empresa, int index)
        {
            if (empresa.Loja == Loja.W4 || empresa.Loja == Loja.Todas)
            {
                using (IDbConnection cnn = new SQLiteConnection(LoadConnectionString()))
                {
                    if (index == 0)
